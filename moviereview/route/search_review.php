<?php
if (! isset($_GET['title'])) {
    responJson(['success' => false, 'messege' => "'title' harus diisi"]);
    exit;
}

//bersihkan data
$content = mysqli_real_escape_string($connection, $_GET['title']);
...
WHERE title LIKE '%".  $content  ."%' order by created_at desc")
